...
def get_init_content():
    with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'manofnet', '__init__.py'), 'r') as f:
        return f.read()
...
KEYWORDS = ["manofnet", "limit", "bandwidth", "network"]
...
PYTHON_REQUIRES = '>= 3'
ENTRY_POINTS = { 'console_scripts': ['manofnet = manofnet.manofnet:run'] }
